...
const ShowHideButton = ({ id, value, item, category, currencyStatusName, }) => {
  ...
  return (
    ...
    <div onClick={()=>handleChangeStatus()} className={`rounded-2xl w-8 h-4 cursor-pointer flex ${status? 'bg-green-500 justify-end':'bg-red-500 justify-start'}`}>
